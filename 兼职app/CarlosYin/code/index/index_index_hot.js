	...
	function pullupRefresh() {
		setTimeout(function() {
			...
			for(var i = cells.length, len = i + 20; i < len; i++) {
				...
				_htmltemp += '	<div class="ub-img1 company-img" style="background-image: url(CarlosYin/Resources/cm2_discover_banner_jp@3x.jpg);"></div>';
				_htmltemp += '	<div class="mui-card-content-inner">';
				_htmltemp += '		<p class="c1"><span>华为</span> | <span>杨过</span></p>';
